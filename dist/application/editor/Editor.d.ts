...
export declare class CoreEditor {
    ...
    constructor({ ketcherId, theme, canvas, mode, }: ICoreEditorConstructorParams);
    ...
    initializeMonomersLibraryFromKetcher(monomersLibraryUpdate?: string | JSON, monomersLibraryReplace?: string | JSON): Promise<void>;
