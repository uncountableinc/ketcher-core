...
export declare function getStructure(ketcherId: string, structureFormat: SupportedFormat | undefined, formatterFactory: FormatterFactory, struct: Struct, drawingEntitiesManager?: DrawingEntitiesManager, selection?: EditorSelection): Promise<string>;
